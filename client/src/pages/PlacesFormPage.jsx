  ...
  return(
    <div>
      ...
      <form onSubmit={savePlace}>
          {preInput('Titile', 'Title for your place. should be short and catch as in advertisement')}
          ...
          {preInput('Checked in&out times, max guests', 'Add check in and out times, remember to have some time window for cleaning the room between guests')}
